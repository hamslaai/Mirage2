...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="addLookupButton">
      ...
      <input type="button" name="{concat('lookup_',@n)}" class="pull-right ds-button-field btn btn-primary ds-add-button" >
    ...
    <xsl:template name="addLookupButtonAuthor">
        <xsl:param name="isName" select="'missing value'"/>
        <button type="button" name="{concat('lookup_',@n)}" class="ds-button-field ds-add-button btn btn-primary ">
            <xsl:attribute name="onClick">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal"><i18n:text>xmlui.ChoiceLookupTransformer.cancel</i18n:text></button>
            </div>
        </div>
    </div>
